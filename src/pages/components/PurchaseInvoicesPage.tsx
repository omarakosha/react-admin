...
const PurchaseInvoicesPage: FC = () => {
  ...
  const handleSaveInvoice = (invoiceData: {
    ...
    if (editingInvoice) {
      ...
      message.success('تمت إضافة فاتورة المشتريات بنجاح');
    }
    ...
    <div className="min-h-screen bg-gray-50 p-6 flex justify-center items-start">
      <div className="w-full max-w-6xl bg-white p-6 rounded-2xl shadow-md">
        ...
        <div className="overflow-x-auto">
            ...
            <Column title="اسم المورد" dataIndex="customerName" key="customerName" width={180} />
        ...
        <InvoiceModalpopup
          ...
          title={editingInvoice ? 'تعديل فاتورة مشتريات' : 'إضافة فاتورة مشتريات'}
          type="purchase"
