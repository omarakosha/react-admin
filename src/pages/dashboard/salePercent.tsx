...
const data: Data = {
  all: [
    { name: { zh_CN: 'الأجهزة المنزلية', en_US: 'appliances' }, value: 4544 },
    { name: { zh_CN: 'شرب الكحول', en_US: 'drinks' }, value: 3321 },
    { name: { zh_CN: 'العناية الشخصية والصحة', en_US: 'health' }, value: 3113 },
    { name: { zh_CN: 'الملابس', en_US: 'clothing' }, value: 2341 },
    { name: { zh_CN: 'الاطفال', en_US: 'baby' }, value: 1231 },
    { name: { zh_CN: 'اخرى', en_US: 'others' }, value: 132 },
  ],
  online: [
    { name: { zh_CN: 'الأجهزة المنزلية', en_US: 'appliances' }, value: 244 },
    { name: { zh_CN: 'شرب الكحول', en_US: 'drinks' }, value: 231 },
    { name: { zh_CN: 'العناية الشخصية والصحة', en_US: 'health' }, value: 311 },
    { name: { zh_CN: 'الملابس', en_US: 'clothing' }, value: 41 },
    { name: { zh_CN: 'الاطفال', en_US: 'baby' }, value: 121 },
    { name: { zh_CN: 'اخري', en_US: 'others' }, value: 111 },
  ],
  offline: [
    { name: { zh_CN: 'الأجهزة المنزلية', en_US: 'appliances' }, value: 99 },
    { name: { zh_CN: 'شرب الكحول', en_US: 'drinks' }, value: 188 },
    { name: { zh_CN: 'العناية الشخصية والصحة', en_US: 'health' }, value: 344 },
    { name: { zh_CN: 'الملابس', en_US: 'clothing' }, value: 255 },
    { name: { zh_CN: 'اخري', en_US: 'others' }, value: 65 },
  ],
};
